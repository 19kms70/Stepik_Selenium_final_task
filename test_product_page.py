...
class TestUserAddToBasketFromProductPage:
    ...
    def setup(self, browser):
        ...
        login_page.should_be_LOGIN_FORM_BUTTON()
        login_page.should_be_REGISTER_FORM_BUTTON()
        login_page.register_new_user(self.register_email, self.register_password)
